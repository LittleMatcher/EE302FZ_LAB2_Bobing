...
public class gamerule_history extends AppCompatActivity {

    Button button_back_gamerule;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gamerule_history);
        ...
        button_back_gamerule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(gamerule_history.this,gamerule.class);//从MainActivity跳转到nextActivity
